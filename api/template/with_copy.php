...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
      <table id="content_footer" border="0" cellpadding="0" cellspacing="0" width="580">
        <tr>
          <td height="60"></td>
        </tr>
      </table>
        ...
        <tr id="header" valign="top">
          <td colspan="3" style="font-family: arial, sans-serif; margin: 0px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
              <tr valign="top">
                <td width="130px;" style="font-family: arial, sans-serif; margin: 0px;"><a
                    href="http://azzurracapital.com.br/"><img
                      src="http://dev.azzurracapital.com.br/images/azzurra__email-address__hero.jpg"
                      width="580" class="CToWUd"></a></td>
              </tr>
              </tbody>
            </table>
          </td>
