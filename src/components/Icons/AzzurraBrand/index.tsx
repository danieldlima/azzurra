  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 375 194" fill="none">
      <g clipPath="url(#a)">
        ...
        <path
          fill="url(#i)"
          d="M188.731 4.622h-2.572l-27.393 61.37h2.572l27.393-61.37Z"
        />
        <path
          fill="url(#j)"
        ...
        <path
          fill="url(#k)"
          d="M202.31 70.114h-45.381l-1.051 2.351h45.388l1.044-2.351Z"
        />
        <path
          fill="url(#l)"
          d="M169.803 78.41h43.646l1.044-2.352h-43.64l-1.05 2.351Z"
        />
        <path
          fill="url(#m)"
          d="M178.752 84.361h17.18l1.043-2.351h-17.172l-1.051 2.351Z"
        />
      </g>
      <defs>
        <linearGradient
