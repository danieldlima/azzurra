...
const AzzurraBrand = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 375 194" fill="none">
            ...
            <defs>
                <linearGradient id="b" x1="95.236" x2="277.515" y1="184.307" y2="184.307"
                                gradientUnits="userSpaceOnUse">
                    <stop offset=".3" stopColor="#B38C3F"/>
                    <stop offset=".48" stopColor="#C3A462"/>
                    <stop offset=".73" stopColor="#DDCA96"/>
                    <stop offset=".75" stopColor="#D1B97E"/>
                    <stop offset=".78" stopColor="#C6A867"/>
                    <stop offset=".81" stopColor="#BD9B55"/>
                    <stop offset=".84" stopColor="#B79248"/>
                    <stop offset=".89" stopColor="#B48D41"/>
                    <stop offset="1" stopColor="#B38C3F"/>
                </linearGradient>
                ...
                <linearGradient id="d" x1="95.235" x2="277.516" y1="184.403" y2="184.403"
                                gradientUnits="userSpaceOnUse">
                    <stop offset=".3" stopColor="#B38C3F"/>
                    <stop offset=".48" stopColor="#C3A462"/>
                    <stop offset=".73" stopColor="#DDCA96"/>
                ...
                <linearGradient id="e" x1="95.236" x2="277.515" y1="184.418" y2="184.418"
                                gradientUnits="userSpaceOnUse">
                    <stop offset=".3" stopColor="#B38C3F"/>
                    <stop offset=".48" stopColor="#C3A462"/>
                    <stop offset=".73" stopColor="#DDCA96"/>
                ...
                <linearGradient id="g" x1="95.236" x2="277.515" y1="184.395" y2="184.395"
                                gradientUnits="userSpaceOnUse">
                    <stop offset=".3" stopColor="#B38C3F"/>
                    <stop offset=".48" stopColor="#C3A462"/>
                    <stop offset=".73" stopColor="#DDCA96"/>
                ...
                <linearGradient id="h" x1="95.236" x2="277.515" y1="184.403" y2="184.403"
                                gradientUnits="userSpaceOnUse">
                    <stop offset=".3" stopColor="#B38C3F"/>
                    <stop offset=".48" stopColor="#C3A462"/>
                    <stop offset=".73" stopColor="#DDCA96"/>
                ...
                <linearGradient id="i" x1="149.544" x2="237.19" y1="24.402" y2="63.875" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#6F5B3C"/>
                    <stop offset=".09" stopColor="#8C703D"/>
                    <stop offset=".17" stopColor="#A17F3E"/>
                    <stop offset=".26" stopColor="#AE883E"/>
                    <stop offset=".33" stopColor="#B38C3F"/>
                    <stop offset=".46" stopColor="#C3A462"/>
                    <stop offset=".62" stopColor="#B38C3F"/>
                    <stop offset=".8" stopColor="#B38C3F"/>
                    <stop offset=".87" stopColor="#B08A3E"/>
                    <stop offset=".91" stopColor="#A7833E"/>
                    <stop offset=".95" stopColor="#99793D"/>
                    <stop offset=".98" stopColor="#846A3C"/>
                    <stop offset="1" stopColor="#6F5B3C"/>
                </linearGradient>
