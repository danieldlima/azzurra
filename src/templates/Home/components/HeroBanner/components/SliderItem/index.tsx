        ...
        <div className="container max-w-6xl mx-auto">
          <div className={'grid-col-2 mx-auto sm:mx-0 sm:px-4 xl:px-0'}>
            <div className="w-full lg:w-3/5 sm:mx-auto lg:mx-0 px-8 sm:px-0">
              <div className="w-64 sm:w-80 mb-10 sm:mb-20 md:mt-8 mx-auto md:mx-0">
                <AzzurraBrand className="w-full h-auto" color={'white'} />
              </div>

              <h2
                className={
                  'text-xl sm:text-3x md:text-4xl lg:text-5xl mb-2 md:mb-6 text-center md:text-left font-light text-azzurra-navy-blue'
                }
              >
